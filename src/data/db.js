...
const SEED = {
    ...
    clubs: [
        ...
        { id: 'cl17', name: 'Книжный клуб МГУ', cityId: 'c1', members: 1000, color: '#aa33ff', hasLogo: true , archetype: { title: 'Клуб человека на границе свободы, морали и абсурда', description: `Клуб постоянно возвращается к одному вопросу: «Что остаётся от человека, когда рушатся привычные опоры — Бог, государство, любовь, разум, мораль, свобода?» Именно поэтому рядом оказываются Камю, Достоевский, Сартр, Кафка, Толстой, Франкл, Фромм, Хаксли, Пелевин и Лю Цысинь.<br><br>Если материализовать клуб в персонажа: 35–50 лет, гуманитарное или очень хорошее техническое образование плюс самообразование. Интеллект высокий, отношение к авторитетам скептическое. Главный страх — прожить чужую жизнь. Главный конфликт — свобода и ответственность. Главное желание — понять устройство человека и мира. Главная слабость — можно слишком долго анализировать жизнь вместо того, чтобы жить.<br><br><div style="font-weight: 700; margin-bottom: 12px; font-size: 1.1em;">📊 ДНК клуба</div><div style="margin-bottom: 12px;">  <div style="font-weight: 700; font-size: 1.2em; color: #aa33ff;">19%</div>  <div style="font-weight: 700;">Человек и его внутренняя природа</div>  <div style="font-size: 0.9em; opacity: 0.8;">Почему человек поступает именно так; противоречия, самообман, идентичность, психика</div></div><div style="margin-bottom: 12px;">  <div style="font-weight: 700; font-size: 1.2em; color: #aa33ff;">17%</div>  <div style="font-weight: 700;">Смысл жизни и экзистенциальные вопросы</div>  <div style="font-size: 0.9em; opacity: 0.8;">Зачем жить, смерть, абсурд, одиночество, конечность существования</div></div><div style="margin-bottom: 12px;">  <div style="font-weight: 700; font-size: 1.2em; color: #aa33ff;">14%</div>  <div style="font-weight: 700;">Мораль, добро и зло</div>  <div style="font-size: 0.9em; opacity: 0.8;">Вина, ответственность, преступление, совесть, возможность оправдания человека</div></div><div style="margin-bottom: 12px;">  <div style="font-weight: 700; font-size: 1.2em; color: #aa33ff;">13%</div>  <div style="font-weight: 700;">Человек и общество / система</div>  <div style="font-size: 0.9em; opacity: 0.8;">Давление общества, государство, идеология, нормы, социальные институты</div></div><div style="margin-bottom: 12px;">  <div style="font-weight: 700; font-size: 1.2em; color: #aa33ff;">10%</div>  <div style="font-weight: 700;">Свобода, выбор и личная автономия</div>  <div style="font-size: 0.9em; opacity: 0.8;">Свободен ли человек, цена выбора, бунт, детерминизм, индивидуальность</div></div><div style="margin-bottom: 12px;">  <div style="font-weight: 700; font-size: 1.2em; color: #aa33ff;">9%</div>  <div style="font-weight: 700;">Отношения, любовь и близость</div>  <div style="font-size: 0.9em; opacity: 0.8;">Любовь, сексуальность, семья, невозможность близости, зависимость от другого</div></div> Именно поэтому клуб не становится сухим философским семинаром.<br><br>Миссия клуба: «Читаем о человеке, чтобы лучше понять, что делать со своей собственной жизнью». Внутренний вопрос: «Что значит быть человеком, когда никто не гарантирует, что жизнь имеет смысл?»` } },
        // Тюмень
...
<div class="arc-section">
  ...
  <div class="arc-traits">Япония · Индия · Армения · Россия · США · Мексика · Вьетнам · Африка · Италия · Испания · Великобритания — высокая открытость другим культурам</div>
    ...
    books: [
        // Quiz placeholder books (no cover — gradient fallback)
        ...
        { id: 'b126', title: 'Средний возраст', author: 'Яна Верзун', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b127', title: 'Ее сторона истории', author: 'Альба де Сеспедес', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b128', title: 'Жизнь не-Ивана', author: 'Белла Арфуди', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b129', title: 'Bookship. Последний книжный магазин во Вселенной', author: 'Мария Закрученко', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b130', title: 'Сахарная пудра', author: 'Маргарита Полонская', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b131', title: 'Потерянная эпопея', author: 'Алис Зенитер', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b132', title: 'Там мое королевство', author: 'Ася Демишкевич', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b133', title: 'Обширная территория', author: 'Симон Лопес Трухильо', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b134', title: 'Не река', author: 'Сельва Альмада', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b135', title: 'Такого света в мире не было до появления N.', author: 'Оксана Васякина', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b136', title: 'Знаки безразличия', author: 'Анна Бабина', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b137', title: 'Пинега', author: 'Варвара Заборцева', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b138', title: 'Последний лист', author: 'Анна Баснер', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b139', title: 'Улица Холодова', author: 'Евгения Некрасова', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b140', title: 'Сначала женщины и дети', author: 'Алина Грабовски', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b141', title: 'Непокои', author: 'Маргарита Ронжина', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b142', title: 'Ночь между июлем и августом', author: 'Дарья Золотова', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b143', title: 'День города', author: 'Надежда Лидваль', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b144', title: 'Астронавты', author: 'Лаура Ферреро', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b145', title: 'Где. Повесть о Второй карабахской войне', author: 'Коля Степанян', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b146', title: 'Верю / не верю', author: 'Сборник рассказов', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b147', title: 'Письма с острова', author: 'Татьяна Бонч-Осмоловская', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b148', title: 'Латинист', author: 'Марк Принс', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b149', title: 'Отвлекаясь', author: 'Федерика Де Паолис', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b150', title: 'Табия тридцать два', author: 'Алексей Конаков', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b151', title: 'Сгинь', author: 'Настасья Реньжина', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b152', title: 'Собакистан. Сад костей', author: 'Виталий Терлецкий и Катя', clubId: 'cl21', color: '#cc88ff', year: 2025, statsOnly: true },
        { id: 'b153', title: 'Дуа за неверного', author: 'Егана Джаббарова', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b154', title: 'Песнь пророка', author: 'Пол Линч', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b155', title: 'Побеги', author: 'Ирина Костарева', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b156', title: 'Рассеяние', author: 'Александр Стесин', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b157', title: 'Выбор воды', author: 'Гала Узрютова', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b158', title: 'Корни: о сплетеньях жизни и семейных тайнах', author: 'Кио Маклир', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b159', title: 'Белград', author: 'Надя Алексеева', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b160', title: 'Шмель', author: 'Аня Гетьман', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b161', title: 'Курорт', author: 'Антон Секисова', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b162', title: 'Необитаемая', author: 'Татьяна Млынчик', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b163', title: 'Развод', author: 'Сьюзен Таубес', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b164', title: 'Сад против времени. В поисках рая для всех', author: 'Оливия Лэнг', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b165', title: 'Лес', author: 'Светлана Тюльбашева', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b166', title: 'Птица скорби', author: 'Мубанга Калимамуквенто', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b167', title: 'Ковентри', author: 'Рейчел Каск', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b168', title: 'Яд', author: 'Таня Коврижка', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b169', title: 'Один и ОК. Как мы учимся быть сами по себе', author: 'Даниэл Шрайбер', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b170', title: 'Под рекой', author: 'Ася Демишкевич', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b171', title: 'Чужая сторона', author: 'Ольга Харитонова', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b172', title: 'Пустые дома', author: 'Бренда Наварро', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b173', title: 'Красные часы', author: 'Лени Зумас', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b174', title: 'Ничто, кроме сердца', author: 'Гриша Пророков', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b175', title: 'Аптечка номер 4', author: 'Булат Ханов', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b176', title: 'Ученичество или книга наслаждений', author: 'Клариси Лиспектор', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b177', title: 'Элена знает', author: 'Клаудиа Пиньейро', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b178', title: 'Так громко, так тихо', author: 'Лена Буркова', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b179', title: 'Течения', author: 'Даша Благова', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b180', title: 'Моя любимая страна', author: 'Елена Костюченко', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b181', title: 'Суть вещи', author: 'Алена Алексина', clubId: 'cl21', color: '#cc88ff', year: 2024, statsOnly: true },
        { id: 'b182', title: 'Спригнфилд', author: 'Сергей Давыдов', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b183', title: 'Дислексия', author: 'Светлана Олонцева', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b184', title: 'Смерть в Персии', author: 'Аннемари Шварценбах', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b185', title: 'чорны лес', author: 'тони лашден', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b186', title: 'Голод', author: 'Светлана Павлова', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b187', title: 'Я желаю пепла своему дому', author: 'Даша Серенко', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b188', title: 'Залив терпения', author: 'Мария Ныркова', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b189', title: 'Новая семья: Гостевой брак, лоскутная семья и другие форматы отношений в современном мире', author: 'Светлана Кольчик', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b190', title: 'Пропавшие наши сердца', author: 'Селеста Инг', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b191', title: 'Ваша жестянка сломалась', author: 'Алла Горбунова', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b192', title: 'Хорея', author: 'Марина Кочан', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b193', title: 'Как слышно', author: 'Артем Роганов', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b194', title: 'Последний день лета', author: 'Андрей Подшибякин', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b195', title: 'Мама, я съела слона', author: 'Дарья Месропова', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b196', title: 'Скоро Москва', author: 'Анна Шипилова', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b197', title: 'Полунощница', author: 'Надя Алексеева', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b198', title: 'Инцелы. Как девственники становятся террористами', author: 'Стефан Краковски', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b199', title: 'И в горе, и в радости', author: 'Мег Мэйсон', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b200', title: 'До самого рая', author: 'Ханья Янагихара', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b201', title: 'Роза', author: 'Оксана Васякина', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b202', title: 'Год порно', author: 'Илья Мамаев-Найлз', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b203', title: 'Нация прозака', author: 'Элизабет Вурцель', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b204', title: 'Величайшее благо', author: 'Оливия Мэннинг', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b205', title: 'Золотинка', author: 'Евгения Некрасова', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b206', title: 'Мальчишки из “Никеля”', author: 'Колсон Уайтхед', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b207', title: 'Пловцы', author: 'Джули Оцука', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true },
        { id: 'b208', title: 'Лисьи броды', author: 'Анна Старобинец', clubId: 'cl21', color: '#cc88ff', year: 2023, statsOnly: true , coverUrl: 'https://ir.ozone.ru/s3/multimedia-1-p/wc1000/9776160493.jpg'},
        { id: 'b209', title: 'Закрытые. Жизнь гомосексуалов в советском союзе', author: 'Рустам Александер', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b210', title: 'Сообщники', author: 'Сборник рассказов', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b211', title: 'Прекрасный мир, где же ты', author: 'Салли Руни', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b212', title: 'Протагонист', author: 'Ася Володина', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b213', title: 'Холодные глаза', author: 'Ислам Ханипаев', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b214', title: 'Нора', author: 'Хироко Оямада', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b215', title: 'Саша, привет!', author: 'Дмитрий Данилов', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b216', title: 'Троя против всех', author: 'Александр Стесин', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b217', title: 'Южный ветер', author: 'Даша Благова', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b218', title: 'Отец смотрит на Запад', author: 'Екатерина Манойло', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b219', title: 'Выше ноги от земли', author: 'Михаил Турбин', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b220', title: 'Вторжение', author: 'Марго Гритт', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b221', title: 'Оккульттрегер', author: 'Алексей Сальников', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b222', title: 'Типа я', author: 'Ислам Ханипаев', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b223', title: 'Святой папочка', author: 'Патрисия Локвуд', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b224', title: 'Зверобой', author: 'Ксения Буржская', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b225', title: 'Ибупрофен', author: 'Булат Ханов', clubId: 'cl21', color: '#cc88ff', year: 2022, statsOnly: true },
        { id: 'b226', title: 'Рана', author: 'Оксана Васякина', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b227', title: 'Памяти памяти', author: 'Мария Степанова', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b228', title: 'Веди свой плуг по костям мертвецов', author: 'Ольга Токарчук', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b229', title: 'Кожа', author: 'Евгения Некрасова', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b230', title: 'Павел Чжан и прочие речные твари', author: 'Вера Богданова', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b231', title: 'Аллегро Пастель', author: 'Лейф Рандт', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b232', title: 'Равноправные. История искусства, женской дружбы и эмансипации в 1960-х', author: 'Мэгги Доэрти', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b233', title: 'Мисс Исландия', author: 'Аудур Ава Олафсдоттир', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b234', title: 'Девочки и институции', author: 'Дарья Серенко', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b235', title: 'Взрослые люди', author: 'Марие Ауберт', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b236', title: 'Семья. О генеалогии, отцовстве и любви', author: 'Дани Шапиро', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b237', title: 'Страстоцвет, или Петербургские подоконники', author: 'Ольга Кушлина', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b238', title: 'Кролиководство', author: 'Бинни Киршенбаум', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b239', title: 'Смерти.net', author: 'Татьяна Замировская', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b240', title: 'Дом иллюзий', author: 'Кармен Мария Мачадо', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b241', title: 'Подтексты', author: 'Евгения Волункова', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b242', title: 'Нулевые', author: 'Роман Сенчин', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b243', title: 'Секция плавания для пьющих в одиночестве', author: 'Саша Карин', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b244', title: 'Мой белый', author: 'Ксения Буржская', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b245', title: 'Покров-17', author: 'Александр Пелевин', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b246', title: 'Невероятные происшествия в женской камере №3', author: 'Кира Ярмыш', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b247', title: 'Плейлист волонтера', author: 'Мршавко Штапич', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b248', title: 'Ты - будущее', author: 'Галина Рымбу', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b249', title: 'Мы так говорим', author: 'Мария Бобылева', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b250', title: 'Кто-нибудь видел мою девчонку', author: 'Карина Добротворская', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        { id: 'b251', title: 'Адвент', author: 'Ксения Букша', clubId: 'cl21', color: '#cc88ff', year: 2021, statsOnly: true },
        {
