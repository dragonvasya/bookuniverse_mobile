...
const SEED = {
    ...
    clubs: [
        ...
        { id: 'cl17', name: 'Книжный клуб МГУ', cityId: 'c1', members: 1000, color: '#aa33ff', hasLogo: true , archetype: { title: 'Клуб человека на границе свободы, морали и абсурда', description: `Клуб постоянно возвращается к одному вопросу: «Что остаётся от человека, когда рушатся привычные опоры — Бог, государство, любовь, разум, мораль, свобода?» Именно поэтому рядом оказываются Камю, Достоевский, Сартр, Кафка, Толстой, Франкл, Фромм, Хаксли, Пелевин и Лю Цысинь.<br><br>Если материализовать клуб в персонажа: 35–50 лет, гуманитарное или очень хорошее техническое образование плюс самообразование. Интеллект высокий, отношение к авторитетам скептическое. Главный страх — прожить чужую жизнь. Главный конфликт — свобода и ответственность. Главное желание — понять устройство человека и мира. Главная слабость — можно слишком долго анализировать жизнь вместо того, чтобы жить.<br><br><ul style="padding-left: 20px; margin: 10px 0;">  <li><strong>Человек и его внутренняя природа (19%)</strong> — почему человек поступает именно так; противоречия, самообман, идентичность, психика</li>  <li><strong>Смысл жизни и экзистенциальные вопросы (17%)</strong> — зачем жить, смерть, абсурд, одиночество, конечность существования</li>  <li><strong>Мораль, добро и зло (14%)</strong> — вина, ответственность, преступление, совесть, возможность оправдания человека</li>  <li><strong>Человек и общество / система (13%)</strong> — давление общества, государство, идеология, нормы, социальные институты</li>  <li><strong>Свобода, выбор и личная автономия (10%)</strong> — свободен ли человек, цена выбора, бунт, детерминизм, индивидуальность</li>  <li><strong>Отношения, любовь и близость (9%)</strong> — любовь, сексуальность, семья, невозможность близости, зависимость от другого</li></ul> Именно поэтому клуб не становится сухим философским семинаром.<br><br>Миссия клуба: «Читаем о человеке, чтобы лучше понять, что делать со своей собственной жизнью». Внутренний вопрос: «Что значит быть человеком, когда никто не гарантирует, что жизнь имеет смысл?»` } },
        // Тюмень
